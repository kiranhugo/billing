...
@Service
public class CreateMediaAssetLocationAttributeCommandHandler implements NewCommandSourceHandler {

    private final MediaAssetWritePlatformService writePlatformService;

    @Autowired
    public CreateMediaAssetLocationAttributeCommandHandler(final MediaAssetWritePlatformService writePlatformService) {
